document.addEventListener('DOMContentLoaded', async function () {
    ...
    // Переменная для адреса бэкэнда
    const backendUrl = 'http://localhost:8080/api/data'; // Укажите адрес вашего бэкэнда

    async function loadData(url) {
        markers.clearLayers(); // Очищаем маркеры перед загрузкой новых данных
